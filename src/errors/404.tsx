...
export default function NotFound() {
  ...
  return (
    <section class="flex items-start justify-center xl:px-[20%] mt-[20vh] flex-col gap-5 p-3">
      ...
      <p>
        I might have messed up a route, or you may have been snooping around.
        All I know is that I don't have this page in my{" "}
        <A
        ...
        >
          <code class=" font-mono text-white bg-black rounded-md p-1">
            routes.ts
            <i class="bi bi-arrow-up-right text-sm ml-3" />
          </code>
        </A>
