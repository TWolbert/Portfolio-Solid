      ...
      <div class="bg-white rounded-xl shadow-md p-8 mb-6">
        ...
        <div class="prose prose-zinc max-w-none">
          <p class="text-lg text-zinc-600 mb-6 leading-relaxed">
            Hi, I'm Teun Wolbert, a full-stack developer passionate about
            building modern, efficient web applications. I love working with
            cutting-edge technologies and creating solutions that are both
            powerful and elegant.
          </p>

          <h2 class="text-2xl font-heading mt-8 mb-4">What I Do</h2>
          <p class="text-zinc-700 mb-4 leading-relaxed">
            I specialize in full-stack web development, working across the
            entire technology stack from frontend interfaces to backend APIs and
            infrastructure. I'm particularly interested in modern JavaScript
            frameworks, PHP development, and creating seamless user experiences.
          </p>
          ...
          <p class="text-zinc-700 mb-4 leading-relaxed">
            ...
            practices. I'm a strong advocate for the Unix philosophy of
            simplicity and modularity, which is reflected in both my system
            setup (Artix Linux with runit) and my development approach. I prefer
            lean, efficient solutions over bloated frameworks, and I always
            strive to understand the tools I use at a fundamental level.
          </p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            >
              ...
              <p class="text-sm text-zinc-600">
                Privacy-focused email service with modern web interface and
            ...
            >
              ...
              <p class="text-sm text-zinc-600">
                Open-source PHP client library for Cerebras AI API with
                streaming support.
              </p>
            </A>
            <A
            ...
            >
              ...
              <p class="text-sm text-zinc-600">
                Christmas event website with registration system and email
                integration.
              </p>
            </A>
            <A
            ...
            >
              ...
              <p class="text-sm text-zinc-600">
                Built with SolidJS and ElysiaJS, showcasing modern web
